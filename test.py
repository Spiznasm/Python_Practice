...
def compute_local_alignment(seq_x, seq_y, scoring_matrix, alignment_matrix):
    ...
    while y_pos !=0:
        ...
        new_y_seq=seq_y[y_pos -1]+new_y_seq
        y_pos -=1
    print new_x_seq,new_y_seq
    
    seq_score = 0
    for dummy_idx in range(len(new_x_seq)):
        seq_score += scoring_matrix[new_x_seq[dummy_idx]][new_y_seq[dummy_idx]]
        print new_x_seq[dummy_idx]," and ",new_y_seq[dummy_idx]," scores ",scoring_matrix[new_x_seq[dummy_idx]][new_y_seq[dummy_idx]]," new total ",seq_score
    return (seq_score,new_x_seq,new_y_seq)
