...
def compute_alignment_matrix(seq_x, seq_y, scoring_matrix, global_flag):
    """Creates a list of lists that represents the alignment matrix.  global_flag = False for local alignment matrix"""
    alignment_matrix = []
...
def compute_local_alignment(seq_x, seq_y, scoring_matrix, alignment_matrix):
    """Returns the best local alignment for seq_x and seq_y, meaning it chooses the best matched substring of each and cuts off the rest"""
    max_score = -float('inf')
